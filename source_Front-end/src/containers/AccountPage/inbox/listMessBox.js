      ...
      if (item?.typeMessage === "IMAGE") {
        return (
          <>
            ...
            >
              <img
                src={`https://mxh-vn.westus.azurecontainer.io/v1/file/${item?.content.file}`}
                alt="userpost"
  ...
  return (
    <>
      ...
      >
        {data?.sender !== cookies.auth.user.id && (
          <Avatar
            src={`https://mxh-vn.westus.azurecontainer.io/v1/image/${userInfo?.avatar}`}
            name="Joe"
          />
        )}
                ...
                {data?.typeMessage === "IMAGE" && (
                  <>
                    <img
                      ...
                      src={`https://mxh-vn.westus.azurecontainer.io/v1/file/${data?.content?.file}`}
                      alt="Akane avatar"
                      width={200}
              ...
              {data?.typeMessage === "DOWNLOAD" && (
                <div className=" max-w-xs">
                  <td
                    ...
                    onClick={() => {
                      window.open(
                        `https://mxh-vn.westus.azurecontainer.io/v1/file/${data?.content.file}`,
                        "_blank"
                      );
                    }}
                  >
